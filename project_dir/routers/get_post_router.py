...
from project_dir.views_part.crud import add_author_session, add_movie_session, add_series_session, add_user_session, \
...
from project_dir.views_part.schemas import AuthorSchema, AuthorCreate, MovieSchema, MovieCreate, SeriesSchema, \
    SeriesCreate, UserCreate
